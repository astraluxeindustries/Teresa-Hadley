  ...
  return (
    <Section id="services" className="bg-premium">
      <div className="text-center max-w-3xl mx-auto mb-20">
        ...
        <p className="text-gray-600">Intercap Lending is the only locally owned Mortgage Bank in Southern Utah, offering products and resources tailored to our community.</p>
      </div>
